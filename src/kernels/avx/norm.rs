    ...
    epsilon: f32
     ...
     unsafe {
        for i in 0..outer_size {
            ...
            let temp = _mm_add_ps(_mm256_castps256_ps128(sum_v), _mm256_extractf128_ps(sum_v, 1));
            ...
            let temp = _mm_add_ps(_mm256_castps256_ps128(sum_sq_v), _mm256_extractf128_ps(sum_sq_v, 1));
            let temp = _mm_add_ps(temp, _mm_movehl_ps(temp, temp));
            let temp = _mm_add_ss(temp, _mm_shuffle_ps(temp, temp, 1));
